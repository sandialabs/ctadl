...
-   `.p`, `.q`, `.f`, `.f.q` are known APs, i.e., they're in the program text
...
If CTADL were to create unrestricted access paths, it would not terminate in general.
